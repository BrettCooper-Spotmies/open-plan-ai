-- Consolidated Fix for Soft Delete RLS Issues
-- This migration fixes the RLS bottleneck in has_project_access 
-- and adds the missing soft-delete RPC functions.

-- 1. Fix the RLS helper function
...
-- 2. Create missing soft-delete RPC functions
