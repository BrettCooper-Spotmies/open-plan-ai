...
export function ViewControls({
  ...
  return (
    <div className="flex items-center gap-1.5 sm:gap-3 min-w-0 justify-end shrink-0 max-w-full">
      {/* View Toggle */}
      ...
      {/* Search Input */}
      <div className="relative flex items-center flex-1 md:flex-none min-w-0 max-w-[150px] sm:max-w-[240px]">
        <Search className="absolute left-3 h-4 w-4 text-muted-foreground shrink-0" />
        <Input
          placeholder="Search tasks..."
          value={searchQuery || ''}
          onChange={(e) => onSearchQueryChange?.(e.target.value)}
          className="pl-9 w-[130px] sm:w-full md:w-[200px] h-9 bg-background focus-visible:ring-1 focus-visible:ring-primary/20 transition-all"
        />
        {searchQuery && (
          <Button
            variant="ghost"
      ...
      {onTaskCreate && (
        <Button 
          ...
          className="gap-2 shrink-0 bg-primary hover:bg-primary/90 text-primary-foreground h-9 ml-2 px-0 w-9 sm:w-auto sm:px-3"
        >
